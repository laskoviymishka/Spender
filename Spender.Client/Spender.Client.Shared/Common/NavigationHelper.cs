...
namespace Spender.Client.Common
{
	/// <summary>
	...
	// Keyboard and mouse navigation only apply when occupying the entire window
		...
		///     to determine if the <see cref="Windows.UI.Xaml.Controls.Frame" /> can go back.
		/// </summary>
		/// <returns>
		///     true if the <see cref="Windows.UI.Xaml.Controls.Frame" /> has at least one entry
		...
		///     to determine if the <see cref="Windows.UI.Xaml.Controls.Frame" /> can go forward.
		/// </summary>
		/// <returns>
		///     true if the <see cref="Windows.UI.Xaml.Controls.Frame" /> has at least one entry

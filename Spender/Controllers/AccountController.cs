// // -----------------------------------------------------------------------
// // <copyright file="AccountController.cs"  company="One Call Care Management, Inc.">
...
namespace Spender.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public UserManager<ExpenseUser> UserManager { get; private set; }
		...
		public async Task<ActionResult> Register(RegisterViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					_categoryBusiness.AddDefaultCategoryList(_userBusiness.GetById(user.Id));
